...
class Willis{
     ...
     */
    row(elems, options){
        var rowHTML = `<div class="${this.config.grid.row()}">${Willis.concatElem(elems)()}</div>`
    ...
    column(nColumns, content, options){
        var columnHTML = `<div class="${this.config.grid.column(nColumns)}">${Object(__WEBPACK_IMPORTED_MODULE_0__util__["a" /* getHTMLString */])(content)}</div>`
    ...
    defineCommonElements(){
        var elemFactory = (element)=>{
            return (content) => {
                return `<${element} class='${this.config[element].class}'>${Object(__WEBPACK_IMPORTED_MODULE_0__util__["a" /* getHTMLString */])(content)}</${element}>`
            }
        }
        ...
        this.addElement("form",([contents])=>{
            return `<form>${Object(__WEBPACK_IMPORTED_MODULE_0__util__["a" /* getHTMLString */])(contents)}</form>`
        })
     ...
     *      elements.
     */
    static concatElem(elems){
        var concatenated = []
        if (elems != undefined){
            elems.forEach((elem)=>{
                concatenated.push(Object(__WEBPACK_IMPORTED_MODULE_0__util__["a" /* getHTMLString */])(elem))
            })
        }
        return ()=>{
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_octicons__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__home_dean_web_willis_src_willis__ = __webpack_require__(0);
...
window.Willis = __WEBPACK_IMPORTED_MODULE_2__home_dean_web_willis_src_willis__["a" /* default */]
window.w = new __WEBPACK_IMPORTED_MODULE_2__home_dean_web_willis_src_willis__["a" /* default */]()
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getHTMLString; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__willis__ = __webpack_require__(0);
...
var getHTMLString = (elem)=>{
    if (elem.constructor === Function){
        ...
        return __WEBPACK_IMPORTED_MODULE_0__willis__["a" /* default */].concatElem(elem)()
    }else{
